...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        "border-slate-700/50 bg-slate-900 z-0 h-full max-h-[800px] w-full max-w-none rounded-xl border text-slate-300 relative",
        className
      )}
    >
      <div className="border-slate-700/50 flex flex-row gap-x-2 border-b p-3">
